...
// (null,"4143","Carlos","Mata","Copa","sin foto",
// "6738","1",1,null,null,null,null,null);
// Personas person2 = new Personas
// (null,"4142","Jose","Mata","Copa","sin foto",
// "6738","1",1,null,null,null,null,null);
...
// UsuariosService
// // usuariosService,
// // ProcesosService procesosService, MenusService menusService, RolesService
// // rolesService,
...
// // Personas personx = new Personas(null,"4143","Carlos",
// // "Mata","Copa","sin foto","6738","1",1,null,null,null,null,null);

// // Personas person1 = new Personas(null, "4143805", "richard", "sivila",
// "rios",
// // null, "67382875", "1", 1,
// // null, null, null, null, null);

// // Personas person2 = new Personas(null, "4143805", "richard", "sivila",
// "rios",
// // null, "67382875", "1", 1,
// // null, null, null, null, null);
...
// // // SolicitudesServicio sc1 = new SolicitudesServicio(null, null, "esto es
// una
// // // problema 1", 1, person1);
// // // SolicitudesServicio sc2 = new SolicitudesServicio(null, null, "esto es
// una
// // // problema 2", 1, person1);
...
// // Procesos procesos1 = new Procesos(null, "Proceso1", "index", "sin ayuda",
// 1,
// // null);
// // Procesos procesos2 = new Procesos(null, "Proceso2", "index", "sin ayuda",
// 1,
// // null);
// // Procesos procesos3 = new Procesos(null, "Proceso3", "index", "sin ayuda",
// 1,
// // null);
...
// // procesos2.setMenus(Set.of(menus3,
...
// // * listamenus.add(menu1); listamenus.add(menu2);
// // procesos1.setMenus(listamenus);
// // */
// // /*
...
// // System.out
// // .println("repository public List<Usuarios> findByLoginAndPassword(String
// // login, String password);");
// // for (Usuarios usuarios : usuariosService.findByLoginAndPassword("uno",
// // "uno")) {
// // System.out.println(
// // usuarios.getPersona().getNombre() + " " + usuarios.getLogin() + " " +
// // usuarios.getPassword());

// // if (usuarios.getRoles() != null) {
// // usuarios.getRoles().forEach(r -> System.out.println("rol es" +
...
// // * println("repository public List<Usuarios> findByLoginLike(String
// login);");
